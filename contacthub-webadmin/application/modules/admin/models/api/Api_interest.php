...
class Api_interest
{
    ...
    public function getAll($filter=[]){
        try {
            $response   = $this->client->request('GET', '/interest',[
                'headers'=> [
    ...
    public function get_datatables($filter=[]){
        try {
            ...
            $response   = $this->client->request('GET', '/interest/paginate',[
                'headers'=> [
                    'Content-Type' => 'application/json'
                ],
                'json' => $filter 
    ...
    public function insert($data=[]){
        try {
            $response   = $this->client->request('POST', '/interest',[
                'headers'=> [
                    'Content-Type' => 'application/json'
                ],
                'json' => $data 
    ...
    public function delete($data=[]){
        try {
            $response   = $this->client->request('DELETE', '/interest',[
                'headers'=> [
                    'Content-Type' => 'application/json'
                ],
                'json' => $data 
