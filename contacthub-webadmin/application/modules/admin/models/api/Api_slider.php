...
class Api_slider
{
    ...
    public function getAll($user_id,$filter=[]){
        try {
            $response   = $this->client->request('GET', '/sliders',[
                'headers'=> [
    ...
    public function getAllNotPaginate($UserId,$filter=[]){
        try {
            $response   = $this->client->request('GET', '/slider/all',[
                'headers'=> [
                    'Content-Type' => 'application/json',
    ...
    public function insert($UserId,$data=[]){
        try {
            $response   = $this->client->request('POST', '/sliders',[
                'headers'=> [
                    'X-Auth-UserId' => $UserId
                ],
                'multipart' => $data 
    ...
    public function update($UserId,$SliderId,$data=[]){
        try {
            $response   = $this->client->request('PUT', '/slider/'.$SliderId,[
                'headers'=> [
                    'X-Auth-UserId' => $UserId
                ],
                'multipart' => $data 
    ...
    public function delete($data){
        try {
            $response   = $this->client->request('DELETE', '/slider/'.$data['SliderId'],[
                'headers'=> [
                    'Content-Type' => 'application/json'
                ],
                'json' => $data
