...
class Api_credit
{
    ...
    public function getAll($user_id,$filter=[]){
        try {
            $response   = $this->client->request('GET', '/credit',[
                'headers'=> [
    ...
    public function get_balance_datatables($filter=[]){
        try {
            $column_order = ['','Name'];
            // Response 200 
            ...
            $response   = $this->client->request('GET', '/credit/balance',[
                'headers'=> [
                    'Content-Type' => 'application/json',
                ],
                'json' => $filter 
    ...
    public function get_datatables($user_id,$filter=[]){
        try {
            ...
            $response   = $this->client->request('GET', '/credit/datatables',[
                'headers'=> [
                    'Content-Type' => 'application/json',
                    'X-Auth-UserId' => $user_id,
                ],
    ...
    public function insert($UserId,$data=[]){
        try {
            $response   = $this->client->request('POST', '/credit',[
                'headers'=> [
                    'Content-Type' => 'application/json',
    ...
    public function update($UserId,$data=[]){
        try {
            $response   = $this->client->request('PUT', '/credit',[
                'headers'=> [
                    'Content-Type' => 'application/json',
                    'X-Auth-UserId' => $UserId
                ],
    ...
    public function delete($UserId,$data){
        try {
            $response   = $this->client->request('DELETE', '/credit',[
                'headers'=> [
                    'Content-Type' => 'application/json',
                    'X-Auth-UserId' => $UserId
                ],
