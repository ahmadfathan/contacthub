    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <h3 class="card-title"><?= lang('label_form_profesi') ?></h3>
              </div>
              <?= form_open_multipart($action_save,array('class'=>'form-horizontal')) ?>
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_profesi') ?></label>
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'ProfessionId','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_profesi')]) ?>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
