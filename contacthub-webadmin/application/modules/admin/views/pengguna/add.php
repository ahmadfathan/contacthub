                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Username','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_username'),'required'=>true,'autocomplete' => "new-password"]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_nickname') ?> <b style="color:red">*</b></label>
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Nickname','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_nickname'),'required'=>true]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_email') ?> <b style="color:red">*</b></label>
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Email','type'=>'email','class'=>'form-control','placeholder'=>lang('label_placeholder_email'),'required'=>true,'autocomplete' => "new-password"]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_password') ?> <b style="color:red">*</b></label>
                            <div class="col-sm-9">
                                <?= form_input(['id'=>'password', 'name'=>'Password','type'=>'password','class'=>'form-control','placeholder'=>lang('label_placeholder_password'),'required'=>true,'autocomplete' => "new-password"]) ?>
                            </div>
                            <div class="col-sm-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <?php echo form_dropdown('RoleId',$data['role'],'',array('id'=>'RoleId', 'class'=>'form-control select2bs4','width'=>'100%','required'=>true));?>
                            </div>
                        </div>
                        <div class="form-group row">
