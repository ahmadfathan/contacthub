...
add_assets_footer($app->load_view_content('pengguna/script_footer_index',$param));
add_modals($app->load_view_content('pengguna/modal_hapus',$param));
add_modals($app->load_view_content('pengguna/modal_view',$param));