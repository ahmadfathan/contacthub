    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <h3 class="card-title"><?= lang('label_form_business_type') ?></h3>
              </div>
                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'BusinessTypeId','type'=>'text','value'=>@$data['BusinessType']->BusinessTypeId,'class'=>'form-control','placeholder'=>lang('label_placeholder_business_type')]) ?>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
