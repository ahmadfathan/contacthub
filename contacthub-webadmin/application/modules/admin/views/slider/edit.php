                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Name','type'=>'text','class'=>'form-control','value' => $data['Slider']->Name,'placeholder'=>lang('label_placeholder_name')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_link') ?></label>
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Link','type'=>'text','class'=>'form-control','value' => $data['Slider']->Link,'placeholder'=>lang('label_placeholder_link')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_dropdown('Status',@$data['Status'],$data['Slider']->Status,array('id'=>'Status', 'class'=>'form-control select2bs4','width'=>'100%'));?>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
