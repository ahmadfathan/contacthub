...
add_assets_footer($app->load_view_content('feed/script_footer_index',$param));
add_modals($app->load_view_content('feed/modal_review',$param));
add_modals($app->load_view_content('feed/modal_reject',$param));