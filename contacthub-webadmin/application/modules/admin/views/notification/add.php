                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Name','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_name_notification')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Body','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_message')]) ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_dropdown('Type',@$data['Type'],'',array('id'=>'Type', 'class'=>'form-control select2bs4','width'=>'100%','required'=>true));?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_dropdown('ArticleId',@$data['Article'],'',array('id'=>'ArticleId', 'class'=>'form-control select2bs4','width'=>'100%'));?>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
                    <div class="card-footer">
                        ...
                        <!-- <?= form_button(['name' => 'Save', 'type'=>'submit','class'=>'btn btn-default','content'=>lang('label_save')]) ?>
