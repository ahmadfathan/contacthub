...
add_assets_footer($app->load_view_content('role/script_footer_index',$param));
add_modals($app->load_view_content('role/modal_hapus',$param));
add_modals($app->load_view_content('role/modal_view',$param));