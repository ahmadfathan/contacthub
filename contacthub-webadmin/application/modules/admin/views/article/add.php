                ...
                <form class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Title','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_title')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_description') ?></label>
                            <div class="col-sm-10">
                                <?= form_textarea(['name'=>'Description','rows'=>3,'type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_description')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label"><?= lang('label_tag') ?></label>
                            <div class="col-sm-10">
                                <?= form_input(['name'=>'Tag','type'=>'text','class'=>'form-control','placeholder'=>lang('label_placeholder_tag')]) ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <?php echo form_dropdown('Category',@$data['Category'],'',array('id'=>'Category', 'class'=>'form-control select2bs4','width'=>'100%'));?>
                            </div>
                        </div>
                        <div class="form-group row">
