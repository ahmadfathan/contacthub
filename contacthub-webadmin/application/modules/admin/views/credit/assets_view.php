...
add_assets_footer($app->load_view_content('credit/script_footer_view',$param));
add_modals($app->load_view_content('credit/modal_hapus',$param));
add_modals($app->load_view_content('credit/modal_view',$param));