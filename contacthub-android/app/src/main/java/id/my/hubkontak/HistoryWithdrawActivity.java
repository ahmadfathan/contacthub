...
public class HistoryWithdrawActivity extends AppCompatActivity {

    private static final String TAG = HistoryWithdrawActivity.class.getSimpleName();
    private static final int REQUEST_WITHDRAW = 100;
    ...
    private HistoryWithdrawAdapter historyAffiliateAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWithdraw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivityForResult(new Intent(HistoryWithdrawActivity.this,WithdrawAffiliateActivity.class),REQUEST_WITHDRAW);
            }
        });
    ...
    private void getHistoryAffiliate(int page){
        ...
        if (page > 1){
            ...
            stringHeader = "";
            historyAffiliateAdapter = new HistoryWithdrawAdapter(this);
            listTransaksi.setVisibility(View.GONE);
            notfoundLayout.setVisibility(View.VISIBLE);

        }
        final RequestQueue requestQueue = Volley.newRequestQueue(this);
        final String url = Uri.parse(API.API_HISTORY_WITHDRAW)
                .buildUpon()
                .toString();
                    ...
                    if (status.equals("OK")){
                        ...
                        if (result.length()>0){
                            ...
                            for (int i = 0;i<result.length();i++){
                                ...
                                String withdrawBank = result.getJSONObject(i).optString("WithdrawBank");
                                String withdrawNoRek = result.getJSONObject(i).optString("WithdrawNoRek");
                                String withdrawPemilikRek = result.getJSONObject(i).optString("WithdrawPemilikRek");
                                ...
                                if(tag.equals("withdraw")){
                                    item.setKeterangan(withdrawBank + " - " + withdrawNoRek + " a.n " + withdrawPemilikRek);
                                }else{
                                    item.setKeterangan("");
                                }
                                item.setTanggal(tgl);
                ...
                if (networkResponse != null) {
                    if (networkResponse.statusCode == 401){
                        ...
                        try {
                            ...
                            new AlertDialog.Builder(HistoryWithdrawActivity.this)
                                    .setMessage(message)
                                    .setPositiveButton("Logout", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            session.clearData();
                                            startActivity(new Intent(HistoryWithdrawActivity.this,LoginActivity.class));
                                            finish();
                                        }
                                    })
                                    .show();
    ...
    class HistoryWithdrawAdapter extends BaseAdapter {
        ...
        public HistoryWithdrawAdapter(Context context) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                switch (rowType) {
                    case TYPE_ITEM:
                        convertView = mInflater.inflate(R.layout.item_withdraw, null);
    ...
    private void getSummaryWithdraw(){
        final RequestQueue requestQueue = Volley.newRequestQueue(this);
        final String url = Uri.parse(API.API_SUMMARY_WITHDRAW)
                .buildUpon()
                .toString();
        txtSaldo.setText("0");
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (status.equals("OK")){
                        ...
                        Double commissionUnpaid = result.optDouble("commissionUnpaid",0);

                        NumberFormat formatter = new DecimalFormat("#,###");
                        String formattedNumber = formatter.format(commissionUnpaid);
                        txtSaldo.setText(formattedNumber);
                    }
                }catch (JSONException e){
                    e.printStackTrace();
                    Toast.makeText(HistoryWithdrawActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
