...
class CityApi(Resource):
    def post(self) -> Response:
        try:
            ...
            if not type(body) is dict:
                body = {}
            result = City.create(self,_id=body['CityId'],ProvinceId=body['ProvinceId'],CityName=body['City'])
    ...
    def delete(self) -> Response:
        try:
            ...
            form = DeleteCityForm().from_json(request.json)
            if not form.validate():
                field = []
                field_msg = []
                for err_key,err_val in form.errors.items():
            ...
            body['_id'] = body['CityId']
            del body['CityId']

            result = City.delete(self,**body)
    ...
    def get(self) -> Response:
        try:
            ...
            result = City.get_data(self,**body)
...
class CityPaginateApi(Resource):
    def get(self) -> Response:
        try:
            default_config = current_app.config
            headers = request.headers
            ...
            result = City.get_paginate(self,**body)
