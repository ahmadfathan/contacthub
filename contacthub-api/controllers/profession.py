...
class CreateProfessionForm(Form):
    ProfessionId = StringField('ProfessionId', [validators.required()])
    
class DeleteProfessionForm(Form):
    ProfessionId = StringField('ProfessionId', [validators.required()])
...
class ProfessionApi(Resource):
    def post(self) -> Response:
        try:
            ...
            form = CreateProfessionForm().from_json(request.json)
            ...
            if not type(body) is dict:
                body = {}
            body['_id'] = body['ProfessionId']
            del body['ProfessionId']
            result = Profession.create(self,**body)
    ...
    def delete(self) -> Response:
        try:
            ...
            form = DeleteProfessionForm().from_json(request.json)
            if not form.validate():
                field = []
                field_msg = []
                for err_key,err_val in form.errors.items():
            ...
            result = Profession.delete(self,**body)
    ...
    def get(self) -> Response:
        try:
            ...
            result = Profession.get_data(self,**body)
...
class ProfessionPaginateApi(Resource):
    def get(self) -> Response:
        try:
            default_config = current_app.config
            headers = request.headers
            ...
            result = Profession.get_paginate(self,**body)
